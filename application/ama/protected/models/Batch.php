...
class Batch extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('batch_code, batch_year', 'required'),
			array('batch_code', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, batch_code, batch_year', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('batch_year',$this->batch_year,true);
