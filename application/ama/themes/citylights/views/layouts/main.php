            ...
            <div class="art-sheet">
                ...
                <div class="art-sheet-body">
                    <div class="art-nav">
                        ...
                        <?php $this->widget('application.components.ArtMenu',array(
							...
							array('label'=>'People','url'=>'#','items'=>array(
								...
								array('label'=>'Alumni', 'url'=>array('/alumni')),
								array('label'=>'Volunteer', 'url'=>array('/volunteer')),
								array('label'=>'Batch', 'url'=>array('/batch')),
								)),
							array('label'=>'Operation','url'=>'#','items'=>array(
								array('label'=>'Donation', 'url'=>'#', 'items'=>array(
									array('label'=>'Cash', 'url'=>array('/user')),
									array('label'=>'Cheques', 'url'=>array('/alumni')),
									array('label'=>'Paypal', 'url'=>array('/paypal')),
								)),
								array('label'=>'Mission Area', 'url'=>array('/mission_area')),
								array('label'=>'Mission Assignment', 'url'=>array('/mission_assign')),
								)),
                    ...
                    <div class="art-header">
                        <div class="art-header-jpeg"></div><br><br>
                        <!--<div class="art-logo">
                        ...
                        <div class="art-footer-inner">
                            ...
                            <div class="art-footer-text">
                                <p><a href="#">Contact Us</a> | <a href="#">Terms of Use</a> | <a href="#">Trademarks</a>
                                    ...
                                    Copyright &copy; ABISADO | CABILDO | LACUATA | 2015 All Rights Reserved</p>
                            </div>
                        </div>
