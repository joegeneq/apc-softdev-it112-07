    <div class="slider-bootstrap"><!-- start slider -->
    	<div class="slider-wrapper theme-default">
            <div id="slider-nivo" class="nivoSlider">
                <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/slider/flickr/image1.jpg" data-thumb="<?php echo Yii::app()->theme->baseUrl;?>/img/slider/flickr/image1.jpg" alt="" title=""/>
                <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/slider/flickr/image2.jpg" data-thumb="<?php echo Yii::app()->theme->baseUrl;?>/img/slider/flickr/image2.jpg" alt="" title="" />
                <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/slider/flickr/image3.jpg" data-thumb="<?php echo Yii::app()->theme->baseUrl;?>/img/slider/flickr/image3.jpg" alt="" title="" />
            </div>
        </div>
