...
<div class="row-fluid">
  ...
  <div class="span6">
    <div class="social-icons pull-right clearfix">
        <div class="" style="text-align:right;"><img src="<?php echo $baseUrl;?>/img/icons/social/facebook.png"  alt="Facebook" /> 
        ...
        <div class="header-text" style="">CONTACT NO: (123) 456 7890</div>
    </div><!--/.social-icons -->
