...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo $baseUrl;?>/img/ico/icon.png">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo $baseUrl;?>/img/ico/144.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo $baseUrl;?>/img/ico/114.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo $baseUrl;?>/img/ico/72.png">
    <link rel="apple-touch-icon-precomposed" href="<?php echo $baseUrl;?>/img/ico/57.png">
  </head>
