...
$this->title = 'AMA Foundation';
?>
<div class="site-index">

    <div class="jumbotron">
        <h1><font color="white">Associate Missionaries of the Assumption</font></h1>

        <p class="lead"><font color="white">PHILIPPINES</font></p>
    ...
    <div class="body-content">
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <p>The Associate Missionaries of the Assumption is a community of young volunteers who are committed to transforming society through joyful service deeply rooted in faith and prayer.
</p>
