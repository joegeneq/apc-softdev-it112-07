...
<aside class="left-side sidebar-offcanvas">
    ...
    <section class="skin-blue sidebar">
        ...
        <?php if (!Yii::$app->user->isGuest) : ?>
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <h2>Hello, <?= @Yii::$app->user->identity->username ?></p>
        ...
        Nav::widget(
            [
                ...
                'items' => [
                    [
                        'label' => '<span class="fa fa-angle-down"></span><span class="text-info">Manage</span>'
                    ],
                    ['label' => '<span class="fa fa-dashboard"></span> User', 'url' => ['/user']],
					['label' => '<span class="fa fa-file-code-o"></span> Alumni', 'url' => ['/alumni']],
                    ['label' => '<span class="fa fa-dashboard"></span> Batch', 'url' => ['/batch']],
                    ['label' => '<span class="fa fa-dashboard"></span> Mission Area', 'url' => ['/area']],
                    ['label' => '<span class="fa fa-dashboard"></span> Mission Assignment', 'url' => ['/mission']],
					//['label' => '<span class="fa fa-dashboard"></span> Assignment', 'url' => ['/assignment']],
        ...
        <!--<ul class="sidebar-menu">
            <li>
                <a href="#" class="navbar-link">
                    <i class="fa fa-angle-down"></i> <span class="text-info">Options</span>
                </a>
            </li>
            <li>
